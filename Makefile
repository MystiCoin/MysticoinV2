#############################################################################
# Makefile for building: Mysticoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: di 8. sep 22:53:12 2015
# Project:  Mysticoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile Mysticoin-qt.pro
#############################################################################
...
Makefile: Mysticoin-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile Mysticoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/Mysticoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/Mysticoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/Mysticoin/src/leveldb/libleveldb.a: FORCE
